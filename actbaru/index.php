                        ...
                        <tbody>
                            <tr>
                                <td style="padding:2px 20px;">
                                    ...
                                    if ($cek['nom_pv'] != 0) { ?>
                                        <button style="text-decoration:none;font-size:14pt " class="btn btn-link" type="button">
                                            <a href="tracking.php?act=<?php echo $cek["id"] ?>&&cat=<?php echo $cek["id_cat"] ?>"><?php echo $cek['name_act']; ?></a>
                                        </button>
                                    <?php
                                    } else {
                                        echo $cek['name_act'];
                                ...
                                <td>
                                    <div class="track">
                                        ...
                                        <button type="button" style="width: 30px;border:none;margin-left:-4px;background:none">
                                            <a href="hapus.php?kode=<?php echo $cek["id"] ?>&&rol=<?php echo $cek["id_cat"] ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">
