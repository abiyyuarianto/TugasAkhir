        ...
        <div class="joko">
            ...
            <div class="conten" style="position:absolute">
                ...
                <form method="POST" action="">
                    ...
                    <div class="kartu-bawah">
                        ...
                        <input type="submit" class="but" value="change" name="edit29" disabled>
                    </div>
                </form>
            ...
            <div class="conten" style="position:absolute;margin-left:322px">
                ...
                <form action="" method="POST">
                    <div class="kartu-tengah">
                        <label style="font-weight:300;font-size:11pt" class="col-form-label">Turn On</label>
                        <input type="checkbox" name="status2" class="form-check" value="aktif" disabled>
                        <label style="font-weight:300;font-size:11pt" class="col-form-label">Note</label>
                        <textarea style="margin-left:-104px;font-size:10pt" name="note" id="" cols="42" rows="5" disabled></textarea>
                    </div>
            ...
            <!-- halaman baru -->
            <?php
            $baru = mysqli_query($conn, " SELECT * FROM tbl_status_transfer where id='$edit'");
            while ($ubah = mysqli_fetch_assoc($baru)) { ?>
                <div class="conten" style="margin-right:3px">
                    <div class="kartu-atas">
                        <label for=""> Transfer</label>
                    </div>
                    <form action="aksi_edit_transfer.php?id=<?php echo $ide ?>&&track=<?php echo $tracke ?>&&kode=<?php echo $kodee ?>" method="POST">
                        <div class="kartu-tengah">
                            <label style="font-weight:300;font-size:11pt" class="col-form-label">Turn On</label>
                            ...
                            <label style="font-weight:300;font-size:11pt" class="col-form-label">Note</label>
                            <textarea style="margin-left:-102px;font-size:10pt" name="note" id="" cols="42" rows="5"> <?php echo $ubah["note"] ?></textarea>
                        </div>

                        <div class="kartu-bawah">
                            <input type="submit" class="but" name="ganti4" value="edit">
                        </div>
                    </form>
                </div>
            <?php } ?>
