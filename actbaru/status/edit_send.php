...
<div style=" width:97vw; height:90vh; margin: 19px auto;">
    <div style=" box-shadow: 0 0 5px 0px black;padding:10px; ">
        ...
        <div class="joko">
            <?php
            $baru = mysqli_query($conn, " SELECT * FROM tbl_status_send where id='$edit'");
            while ($ubah = mysqli_fetch_assoc($baru)) { ?>
                <div class="conten" style="position:absolute">
                    ...
                    <form method="POST" action="aksi_edit_send.php?id=<?php echo $ide ?>&&track=<?php echo $tracke ?>&&kode=<?php echo $kodee ?>">
                        ...
                        <div class="kartu-bawah">
                            ...
                            <input type="submit" class="but" value="edit" name="edit29" id="">
                        </div>
                    </form>
